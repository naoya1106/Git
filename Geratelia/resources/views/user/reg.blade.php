...
@section('form')
    <div class="reg-form">
            ...
            <!-- 登録フォーム -->
            <form method='post' action="{{ url('/store') }}" class='login-form'>
            {{ csrf_field() }}
            <!-- バリデーションによる検証後、storeアクションに送信 -->
                ...
                <input type="text" class="mail" name="mail" placeholder="enter mail-address" value="{{ old('mail') }}"><br>
                    @if ($errors->has('mail'))
